from tkinter import *
from functools import partial # To prevent
...
class HistoryExport:
    ...
    def __init__ (self, partner, calculations):
        ...
        export_instruction_txt = ("Please push <Export> to save your calculations in your"
                                   "file. If the file name already exists, it will be saved")
        ...
        for count, item in enumerate(history_labels_list):
            make_label = Label(self.history_box, text=item[0], font=item[1],
                               bg=item[2],
                               wraplength=300, justify="left", padx=10, pady=10)
        ...
        for btn in buttons_details_list:
